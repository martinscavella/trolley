...
Non dimenticare niente. È la funzione più semplice dell'app ed è una di quelle che deve essere **alla pari o meglio** di uno strumento specializzato: legata alle date e ai compagni, una lista qui è già superiore a una nota generica.

---

## Schermate

- **Liste del viaggio** — la lista condivisa e la propria
- **Voce** — cosa, quante, chi la porta

---

## Regole di comportamento

1. **Esistono due liste**: quella **del viaggio**, che vedono tutti, e quella **personale**, che vede solo chi la scrive.
...
- Liste suggerite in base a destinazione o stagione
- Modelli di lista da riusare fra viaggi
