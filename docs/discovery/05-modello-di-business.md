...
| **Mappe e percorsi** | **a chiamata** | La navigazione in tempo reale dentro l'app richiede un servizio di mappe e percorsi che si paga a chiamata. È l'unico costo variabile che cresce con **l'uso** e non con le registrazioni: chi naviga tutto il giorno costa più di dieci persone che aprono l'app due volte. Serve un tetto per utente e per viaggio dalla prima release |
